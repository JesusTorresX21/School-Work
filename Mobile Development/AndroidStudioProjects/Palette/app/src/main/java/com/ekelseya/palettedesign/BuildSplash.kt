...
class BuildSplash : AppCompatActivity() {
    ...
    var paletteArray = ArrayList<Palette>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val paletteListSave = findViewById<Button>(R.id.paletteSaveButton)
        ...
        fun accentVisibility(){
            ...
            paletteListSave.visibility = View.VISIBLE
        }
...
//        }
        ...
        paletteListSave.setOnClickListener {
            val palNameTest = paletteNameBox.text.toString()
            val newPalette = Palette(primaryBlock,secondaryBlock,tertiaryBlock,accentBlock,palNameTest)
            onSave(newPalette)
        }
    }
    ...
    private fun onSave(pal: Palette) {
        onLoad()
        paletteArray.add(pal)
...
//                for ((key, value) in paletteMap) {
//                    Log.i("Load","$key = $value")
//                }
            }
        }
    }
